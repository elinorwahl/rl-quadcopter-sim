...
class PhysicsSim():
    ...
    def next_timestep(self, rotor_speeds):
        ...
        # angles = self.pose[3:] + self.angular_v * self.dt + 0.5 * self.angular_accels * self.angular_accels * self.dt**2 # this is wrong and needs to be removed and replaced with the following
