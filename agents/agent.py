...
class Actor:
    ...
    def build_model(self):
        ...
        raw_actions = layers.Dense(units=self.action_size, activation='sigmoid', kernel_initializer=layers.initializers.RandomUniform(minval=-0.003, maxval=0.003),
...
class DDPG():
    ...
    def reset_episode(self):
        self.total_reward = 0.0 # start a count for updating rewards
        self.count = 0 # start a count for steps taken 
        self.noise.reset()
